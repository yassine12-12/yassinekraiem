      ...
      >
        ...
        >
          ...
          <p className="text-gray-300 mb-6 max-w-3xl mx-auto">
            Specializing in <strong className="text-white">Artificial Intelligence and Data Science</strong> with advanced 
            computational methods, machine learning applications, and research in intelligent automation systems.
          </p>
          <div className="flex justify-center flex-wrap gap-3">
            {['AI Research', 'Machine Learning', 'Data Science', 'Computational Methods', 'Engineering Simulation'].map((focus, index) => (
              <span
                key={index}

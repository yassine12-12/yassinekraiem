  ...
  return (
    <section className="c-space my-20" id="projects">
      <div className="text-center mb-16">
        <p className="text-5xl font-bold text-white mb-6">Featured Projects</p>
      ...
      <div className="mb-20">
        <h3 className="text-2xl font-semibold mb-8 text-center text-cyan-400">Computer Science & AI</h3>
        <div className="grid xl:grid-cols-2 grid-cols-1 gap-8">
          {computerScienceProjects.map((project, index) => (
            <div
              key={index}
              className="card-glow card-glow-cyan flex flex-col gap-5 relative p-6 shadow-2xl border border-gray-500/30 rounded-xl hover:border-cyan-400/50 transition-all duration-500 transform hover:scale-[1.02]"
            >
                ...
                <div className="flex gap-2">
                  {project.github && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="text-cyan-400 hover:text-cyan-300 text-sm hover:underline transition-colors duration-300"
                    >
      ...
      <div>
        ...
        <div className="grid xl:grid-cols-2 grid-cols-1 gap-8">
          {mechanicalProjects.map((project, index) => (
            <div
              key={index}
              className="card-glow card-glow-orange flex flex-col gap-5 relative p-6 shadow-2xl border border-gray-500/30 rounded-xl hover:border-orange-400/50 transition-all duration-500 transform hover:scale-[1.02]"
            >
              {project.model && (
                <div 

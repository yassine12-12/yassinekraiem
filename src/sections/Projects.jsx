...
const Model3DLoading = () => (
  <div className="h-full w-full flex items-center justify-center bg-gradient-to-br from-orange-500/10 to-red-500/10">
...
const CornerLinkBadge = ({ href, onClick, label, children }) => {
  ...
  return (
    <Tag
      ...
      aria-label={label}
      title={label}
      className="w-9 h-9 flex items-center justify-center rounded-full bg-black/60 backdrop-blur-sm border border-white/15 text-white/80 hover:text-white hover:bg-black/80 hover:border-white/30 transition-all duration-300"
